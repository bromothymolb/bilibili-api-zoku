...
- fix: update subtitle_lan.json in `Nemo2011` [#1040] by @Nemo2011 in e8ab10bd1127a1a0774721d05f7f34a6051019f1
- fix(HTTPXClient): files in request aren't processed by @Nemo2011 in dbba7b9db2df1167975b170f2f80834b3c4d1c2d
- fix(video): exception in parsing danmakus by @Algebra000 in `Nemo2011` [#1043]
- fix(article/session): wbi related issues by @bromothymolb in a0839d025ad0d0719b8be92e58cb6d0df58a3ba3
- feat(session): add session.upload_image by @bromothymolb in 63e5f26f74b027015730bf0fc4556775ad8bb6e7
...
- fix(article): 专栏页面消失导致 get_all 失效 ([#994](https://github.com/Nemo2011/bilibili-api/issues/994))
- fix(article): article.fetch_content() error on picture html nodes
- fix(AsyncEvent): AsyncEvent 中被 dispatch 的 Task 没有保持引用 by @capric98 in [#1030](https://github.com/Nemo2011/bilibili-api/pull/1030)
- fix(Credential): 从 cookies 中移除 proxy 字段，防止其在请求中被发送 by @ridiculers in [#1025](https://github.com/Nemo2011/bilibili-api/pull/1025)
- fix(LiveDanmaku): 确保 `__status` 被设置成 STATUS_ERROR by @capric98 in [#1019](https://github.com/Nemo2011/bilibili-api/pull/1019)
- fix(LiveRoom): 直播间禁言（无视参数永久禁言 / 无法本场次禁言） by @god-what-is-that in [#1009](https://github.com/Nemo2011/bilibili-api/pull/1009) [#1010](https://github.com/Nemo2011/bilibili-api/pull/1010)
- fix(login): QrCodeLogin TV cookies identify error ([#1032](https://github.com/Nemo2011/bilibili-api/issues/1032))
- fix(VDURLDDetecter): handle potential error in SAR parsing for sar == "N/A" by @machsix in [#1017](https://github.com/Nemo2011/bilibili-api/pull/1017)
- fix(VDURLDDetecter): hvc1 matching ([#1035](https://github.com/Nemo2011/bilibili-api/issues/1035)) / `detect()` codecs param ignored

---

- feat(INITIAL_STATE): enable handling JSON parsing with percent-encoding by @astro-jingtao in [#1027](https://github.com/Nemo2011/bilibili-api/pull/1027)
- feat(VDURLDDetecter): add missing fields in dash ([#995](https://github.com/Nemo2011/bilibili-api/issues/995))

---

- docs(readme): 更好的脚注实现方式 by @kndxhz in [#999](https://github.com/Nemo2011/bilibili-api/pull/999)

---

- chore: `Api` 类已于根模块处暴露，可通过 `bilibili_api.Api` 访问。
...
- fix(parser): isfunction return False for class method [#724](https://github.com/Nemo2011/bilibili-api/issues/724) by @phanen and @Drelf2018 in [#987](https://github.com/Nemo2011/bilibili-api/issues/987)
- fix!: `BiliAPIClient` 添加 `download_close` 函数
- fix: session.fetch_session_msgs [#989](https://github.com/Nemo2011/bilibili-api/issues/989)
- feat(ass): 新增 `ass.AssSubtitleObject` 增加字幕格式的输出 by @STHUDY in [#990](https://github.com/Nemo2011/bilibili-api/pull/990)
- feat: 添加充电问答相关api by @Cherrysaber in [#993](https://github.com/Nemo2011/bilibili-api/pull/993)
