...
+ 文档
  + 通用
    ...
    + [`AsyncEvent` 类](common/async-event.md)
    + [`Picture` 类](common/picture.md)
    + [请求配置](common/configuration.md)
    + [模块配置](common/bili_settings.md)
    + [日志](common/logging.md)
    + [根模块函数](common/root-functions.md)
  + 子模块相关
    + [专栏](sub/article.md)
    + [番剧](sub/bangumi.md)
    + [动态](sub/dynamic.md)
    + [互动视频](sub/ivifile.md)
    + [登录与 `Geetest` 类](sub/login.md)
    + [图文](sub/opus.md)
    + [用户](sub/user.md)
    + [视频](sub/video.md)
    + [获取 vote_id](sub/vote_id.md)
  + 进阶
    + [`Api` 类](advance/api.md)
    + [使用 `get_client`](advance/client.md)
    + [`BiliAPIClient` 适配](advance/request_client.md)
    + [`Credential` 类](advance/credential.md)
    + [使用 `instance`](advance/instance.md)
    + [设置 `instance`](advance/settings.md)
    + [过滤器](advance/filter.md)
+ API 示例
