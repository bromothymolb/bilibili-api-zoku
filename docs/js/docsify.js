...
!(function () {
  ...
  const t = n((e) => e.replace(/([A-Z])/g, (e) => "-" + e.toLowerCase()));
  function i(e) {
  ...
  function r(e) {
    ...
    return (
      ("string" == typeof n[1] &&
        n[1].length > 0 &&
        n[1].toLowerCase() !== location.protocol) ||
      ("string" == typeof n[2] &&
        n[2].length > 0 &&
        n[2].replace(
          new RegExp(
  ...
  function s(e, n = !1) {
    if ("string" == typeof e) {
      if (void 0 !== window.Vue) return f(e);
      e = n ? f(e) : c[e] || (c[e] = f(e));
    }
    return e;
  }
  function u(e, n, t) {
    const i = s(e);
    i && (i[t ? "outerHTML" : "innerHTML"] = n);
  }
  const l = document,
    p = l.body,
    d = l.head;
  function f(e, n = ":is()") {
    return "string" != typeof e ? e.querySelector(n) : l.querySelector(e);
  }
  function g(e, n = ":is()") {
    return Array.from(
      "string" != typeof e ? e.querySelectorAll(n) : l.querySelectorAll(e),
    );
  }
  function v(e, n) {
    const t = l.createElement(e);
    return (n && (t.innerHTML = n), t);
  }
  function h(e, n) {
  ...
  var S =
      (x ||
        ...
        (function (e) {
          var n = (function (e) {
            var n = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
              ...
              o = {
                ...
                util: {
                  encode: function e(n) {
                    return n instanceof a
                      ? new a(n.type, e(n.content), n.alias)
                      : Array.isArray(n)
                        ? n.map(e)
                        : n
                            .replace(/&/g, "&amp;")
                  ...
                  clone: function e(n, t) {
                    ...
                    switch (((t = t || {}), o.util.type(n))) {
                      case "Object":
                        if (((a = o.util.objId(n)), t[a])) return t[a];
                        for (var r in ((i = {}), (t[a] = i), n))
                          n.hasOwnProperty(r) && (i[r] = e(n[r], t));
                        return i;
                      case "Array":
                        return (
                          (a = o.util.objId(n)),
                ...
                languages: {
                  ...
                  insertBefore: function (e, n, t, i) {
                    var a = (i = i || o.languages)[e],
                      r = {};
                    for (var c in a)
                      if (a.hasOwnProperty(c)) {
                        if (c == n)
                          for (var s in t) t.hasOwnProperty(s) && (r[s] = t[s]);
                        t.hasOwnProperty(c) || (r[c] = a[c]);
                      }
                    var u = i[e];
                    return (
                      (i[e] = r),
                ...
                highlightAllUnder: function (e, n, t) {
                  ...
                  for (var a, r = 0; (a = i.elements[r++]); )
                    o.highlightElement(a, !0 === n, i.callback);
                },
                ...
                highlight: function (e, n, t) {
                  var i = { code: e, grammar: n, language: t };
                  ...
                  return (
                    ...
                    a.stringify(o.util.encode(i.tokens), i.language)
                  );
                },
                ...
                hooks: {
                  ...
                  run: function (e, n) {
                    var t = o.hooks.all[e];
                    if (t && t.length) for (var i, a = 0; (i = t[a++]); ) i(n);
                  },
                },
                Token: a,
              };
            ...
            function c(e, n, t, i, s, p) {
              for (var d in t)
                if (t.hasOwnProperty(d) && t[d]) {
                  var f = t[d];
                  f = Array.isArray(f) ? f : [f];
                  for (var g = 0; g < f.length; ++g) {
                    if (p && p.cause == d + "," + g) return;
                    var v = f[g],
                      h = v.inside,
                      m = !!v.lookbehind,
                      _ = !!v.greedy,
                      b = v.alias;
                    if (_ && !v.pattern.global) {
                      var k = v.pattern.toString().match(/[imsuy]*$/)[0];
                      v.pattern = RegExp(v.pattern.source, k + "g");
                    }
                    for (
                      var w = v.pattern || v, y = i.next, x = s;
                      y !== n.tail && !(p && x >= p.reach);
                      ...
                      if (!($ instanceof a)) {
                        var S,
                          A = 1;
                        if (_) {
                          if (!(S = r(w, x, e, m)) || S.index >= e.length)
                            break;
                          var E = S.index,
                            T = S.index + S[0].length,
                            R = x;
                          for (R += y.value.length; E >= R; )
                            R += (y = y.next).value.length;
                          if (((x = R -= y.value.length), y.value instanceof a))
                            continue;
                          for (
                            var L = y;
                            L !== n.tail &&
                            (R < T || "string" == typeof L.value);
                            L = L.next
                          )
                            (A++, (R += L.value.length));
                          (A--, ($ = e.slice(x, R)), (S.index -= x));
                        } else if (!(S = r(w, 0, $, m))) continue;
                        E = S.index;
                        var j = S[0],
                          C = $.slice(0, E),
                          z = $.slice(E + j.length),
                          q = x + $.length;
                        p && q > p.reach && (p.reach = q);
                        var F = y.prev;
                        if (
                          (C && ((F = u(n, F, C)), (x += C.length)),
                          l(n, F, A),
                          (y = u(
                            n,
                            F,
                            new a(d, h ? o.tokenize(j, h) : j, b, j),
                          )),
                          z && u(n, y, z),
                          A > 1)
                        ) {
                          var P = { cause: d + "," + g, reach: q };
                          (c(e, n, t, y.prev, x, P),
                            p && P.reach > p.reach && (p.reach = P.reach));
                        }
                      }
                    }
                  }
            ...
            function u(e, n, t) {
              var i = n.next,
                o = { value: t, prev: n, next: i };
              return ((n.next = o), (i.prev = o), e.length++, o);
            }
            function l(e, n, t) {
              for (var i = n.next, o = 0; o < t && i !== e.tail; o++)
                i = i.next;
            ...
            if (
              ...
              (a.stringify = function e(n, t) {
                ...
                (r &&
                  (Array.isArray(r)
                    ? Array.prototype.push.apply(a.classes, r)
                    : a.classes.push(r)),
                  o.hooks.run("wrap", a));
                var c = "";
                    ...
                    e.addEventListener(
                      ...
                      function (n) {
                        var t = JSON.parse(n.data),
                          ...
                          a = t.code,
                          r = t.immediateClose;
                        (e.postMessage(o.highlight(a, o.languages[i], i)),
                          r && e.close());
                      },
                      !1,
                    ),
            ...
            (function () {
              if (void 0 !== n && "undefined" != typeof document) {
                ...
                (n.hooks.add("before-highlightall", function (e) {
                  ...
                  n.hooks.add("before-sanity-check", function (r) {
                    var c = r.element;
                    if (c.matches(a)) {
                      ((r.code = ""), c.setAttribute(t, i));
                      var s = c.appendChild(document.createElement("CODE"));
                      ...
                      (n.util.setLanguage(s, l), n.util.setLanguage(c, l));
                            ...
                            if (i) {
                              ...
                              (r < 0 && (r += a.length),
                                ...
                                c.hasAttribute("data-start") ||
                                  c.setAttribute("data-start", String(r + 1)));
                            }
                            ((s.textContent = e), n.highlightElement(s));
                          },
                          function (e) {
                            (c.setAttribute(t, "failed"), (s.textContent = e));
                          },
                        ));
                    }
                  }),
                  (n.plugins.fileHighlight = {
                    highlight: function (e) {
                      for (
                        var t, i = (e || document).querySelectorAll(a), o = 0;
                        (t = i[o++]);
                      )
      ...
      $.exports),
    A = e({ __proto__: null, default: y(S) }, [S]);
  ...
  function L(e, n = []) {
    ...
    for (const i in e)
      n.indexOf(i) > -1 ||
        t.push(e[i] ? `${T(i)}=${T(e[i])}`.toLowerCase() : T(i));
    return t.length ? `?${t.join("&")}` : "";
  }
  function j(e) {
    const [n, t] = e.split("?");
    if (!t) return e;
    const i = new URLSearchParams(t).get("id");
    return null !== i ? `${n}?id=${i}` : n;
  }
  const C = n((e) => /(:|(\/{2}))/g.test(e)),
    z = n((e) => e.split(/[?#]/)[0]),
    q = n((e) => {
    ...
    F = n((e) => e.replace(/^\/+/, "/").replace(/([^:])\/{2,}/g, "$1/")),
    P = n((e) => {
      const n = e.replace(/^\//, "").split("/"),
        t = [];
      for (const e of n) ".." === e ? t.pop() : "." !== e && t.push(e);
      return "/" + t.join("/");
    });
  function M(e) {
    return e
  ...
  function O(...e) {
    return F(e.map(M).join("/"));
  }
  const I = n((e) => e.replace("#", "?id="));
  class N {
    #e = {};
    constructor(e) {
      this.config = e;
    ...
    #n(e, n, t) {
      const i = Object.keys(n).filter(
        (n) =>
          (this.#e[n] || (this.#e[n] = new RegExp(`^${n}$`))).test(e) &&
          e !== t,
      )[0];
      return i ? this.#n(e.replace(this.#e[i], n[i]), n, e) : e;
    }
    #t(e, n) {
      const [t, i] = e.split("?"),
        o = new RegExp(`\\.(${n.replace(/^\./, "")}|html)$`).test(t)
          ? t
          : /\/$/g.test(t)
            ? `${t}README${n}`
            : `${t}${n}`;
    ...
    getFile(e = this.getCurrentPath(), n = !1) {
      const { config: t } = this,
        i = this.getBasePath(),
        o = "string" == typeof t.ext ? t.ext : ".md";
      return (
        (e = t.alias ? this.#n(e, t.alias) : e),
        (e = ((e = this.#t(e, o)) === `/README${o}` && t.homepage) || e),
        (e = C(e) ? e : O(i, e)),
        n && (e = e.replace(new RegExp(`^${i}`), "")),
        e
      );
    }
    onchange(e = o) {
    ...
    toURL(e, n, t) {
      ...
      if (
        ((o.query = { ...o.query, ...n }),
        (e = (e = o.path + L(o.query)).replace(/\.md(\?)|\.md$/, "$1")),
        i)
      ) {
        const n = t.indexOf("?");
        e = (n > 0 ? t.substring(0, n) : t) + e;
      }
  ...
  class D extends N {
    ...
    getBasePath() {
      const e = window.location.pathname || "",
        ...
        t = e.endsWith(".html") ? e + "#/" + n : e + "/" + n;
      return /^(\/|https?:)/g.test(n) ? n : F(t);
    }
    getCurrentPath() {
    ...
    onchange(e = o) {
      let n = !1;
      (_("click", (t) => {
        const i = "A" === t.target.tagName ? t.target : t.target.parentNode;
        if (i && "A" === i.tagName && !r(i.href)) {
          if (((n = !0), ["app-name-link", "page-link"].includes(i.className)))
            return;
          i.hash === location.hash && e({ event: t, source: "navigate" });
        }
      }),
        _("hashchange", (t) => {
          const i = n ? "navigate" : "history";
          ((n = !1), e({ event: t, source: i }));
        }));
    }
    normalize() {
      let e = this.getCurrentPath();
      if (((e = I(e)), "/" === e.charAt(0))) return B(e);
      B("/" + e);
    }
    parse(e = location.href) {
      let n = "";
      const t = e.indexOf("#");
      t >= 0 && (e = e.slice(t + 1));
      const i = e.indexOf("?");
      return (
        ...
        { path: e, file: this.getFile(e, !0), query: R(n), response: {} }
      );
    }
    toURL(e, n, t) {
  ...
  class H extends N {
    ...
    onchange(e = o) {
      (_("click", (n) => {
        const t = "A" === n.target.tagName ? n.target : n.target.parentNode;
        if (t && "A" === t.tagName && !r(t.href)) {
          n.preventDefault();
          const i = t.href;
          (window.history.pushState({ key: i }, "", i),
            e({ event: n, source: "navigate" }));
        }
      }),
        _("popstate", (n) => {
    ...
    parse(e = location.href) {
      let n = "";
      const t = e.indexOf("?");
      t >= 0 && ((n = e.slice(t + 1)), (e = e.slice(0, t)));
      const i = O(location.origin),
        o = e.indexOf(i);
      return (
        o > -1 && (e = e.slice(o + i.length)),
        { path: e, file: this.getFile(e), query: R(n), response: {} }
      );
    }
    normalize() {}
  }
  ...
  const W = getComputedStyle(document.documentElement, null).getPropertyValue(
    "--_mobile-breakpoint",
  );
  function V() {
    return window?.matchMedia?.(`(max-width: ${W})`)?.matches;
  }
  function Q() {
    return {
      async: !1,
    ...
    let t = "string" == typeof e ? e : e.source,
      i = {
        replace: (e, n) => {
          ...
          return ((o = o.replace(ne.caret, "$1")), (t = t.replace(e, o)), i);
        },
  ...
  var ee = ((e = "") => {
    ...
    ye = /[^\s\p{P}\p{S}]/u,
    xe = K(/^((?![*_])punctSpace)/, "u")
      .replace(/punctSpace/g, we)
      .getRegex(),
    $e = /(?!~)[\p{P}\p{S}]/u,
    Se = K(/link|precode-code|html/, "g")
      .replace(
        "link",
        /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
      )
    ...
    Ee = K(Ae, "u").replace(/punct/g, ke).getRegex(),
    Te = K(Ae, "u").replace(/punct/g, $e).getRegex(),
    Re =
    ...
    Pe = K(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
      ...
      .getRegex(),
    Me = K(de).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
    Oe = K(
    ...
    Ue = {
      ...
      punctuation: xe,
      reflink: Be,
      reflinkSearch: K("reflink|nolink(?!\\()", "g")
        .replace("reflink", Be)
        .replace("nolink", De)
        .getRegex(),
      tag: Oe,
    ...
    We = {
      ...Ge,
      br: K(be).replace("{2,}", "*").getRegex(),
      text: K(Ge.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
    },
    Ve = { normal: ve, gfm: me, pedantic: _e },
    Qe = { normal: Ue, gfm: Ge, breaks: We, pedantic: Ze },
    Ye = {
      "&": "&amp;",
      "<": "&lt;",
      ">": "&gt;",
  ...
  function Je(e, n) {
    if (n) {
      if (ne.escapeTest.test(e)) return e.replace(ne.escapeReplace, Xe);
    } else if (ne.escapeTestNoEncode.test(e))
      return e.replace(ne.escapeReplaceNoEncode, Xe);
    return e;
  }
  function Ke(e) {
    try {
  ...
  function en(e, n) {
    ...
    if (
      (t[0].trim() || t.shift(),
      t.length > 0 && !t.at(-1)?.trim() && t.pop(),
      n)
    )
      if (t.length > n) t.splice(n);
      else for (; t.length < n; ) t.push("");
    for (; i < t.length; i++) t[i] = t[i].trim().replace(ne.slashPipe, "|");
    return t;
  }
  function nn(e, n, t) {
    let i = e.length;
  ...
  function tn(e) {
    let n = e.split("\n"),
      t = n.length - 1;
    for (; t >= 0 && ne.blankLine.test(n[t]); ) t--;
    return n.length - t <= 2 ? e : n.slice(0, t + 1).join("\n");
  }
  function on(e, n = 0) {
    let t = n,
      i = "";
  ...
  function an(e, n, t, i, o) {
    let a = n.href,
      r = n.title || null,
      c = e[1].replace(o.other.outputLinkReplace, "$1");
    i.state.inLink = !0;
    let s = {
  ...
  var rn = class {
      ...
      code(e) {
        ...
        if (n) {
          let e = this.options.pedantic ? n[0] : tn(n[0]),
            t = e.replace(this.rules.other.codeRemoveIndent, "");
          return { type: "code", raw: e, codeBlockStyle: "indented", text: t };
        }
      }
      fences(e) {
        ...
        if (n) {
          let e = n[0],
            t = (function (e, n, t) {
              let i = e.match(t.other.indentCodeCompensation);
              if (null === i) return n;
              let o = i[1];
              return n
                .split("\n")
                .map((e) => {
                  let n = e.match(t.other.beginningSpace);
                  if (null === n) return e;
                  let [i] = n;
                  return i.length >= o.length ? e.slice(o.length) : e;
                })
                .join("\n");
            })(e, n[3] || "", this.rules);
          return {
      ...
      hr(e) {
        ...
        if (n) return { type: "hr", raw: nn(n[0], "\n") };
      }
      blockquote(e) {
        ...
        if (n) {
          ...
          for (; e.length > 0; ) {
            ...
            for (n = 0; n < e.length; n++)
              if (this.rules.other.blockquoteStart.test(e[n]))
                (r.push(e[n]), (a = !0));
              else {
                if (a) break;
                r.push(e[n]);
            ...
            if (
              ...
              this.lexer.blockTokens(s, o, !0),
              (this.lexer.state.top = u),
              0 === e.length)
            )
              break;
            let l = o.at(-1);
            if ("code" === l?.type) break;
            if ("blockquote" === l?.type) {
              let n = l,
                a = n.raw + "\n" + e.join("\n"),
                r = this.blockquote(a);
              ((o[o.length - 1] = r),
                (t = t.substring(0, t.length - n.raw.length) + r.raw),
                (i = i.substring(0, i.length - n.text.length) + r.text));
              break;
            }
            if ("list" !== l?.type);
            else {
              let n = l,
                ...
                r = this.list(a);
              ((o[o.length - 1] = r),
                (t = t.substring(0, t.length - l.raw.length) + r.raw),
                (i = i.substring(0, i.length - n.raw.length) + r.raw),
                (e = a.substring(o.at(-1).raw.length).split("\n")));
            }
          }
          return { type: "blockquote", raw: t, tokens: o, text: i };
        }
      }
      list(e) {
        ...
        if (n) {
          ...
          let a = this.rules.other.listItemRegex(t),
            r = !1;
          for (; e; ) {
            let t = !1,
              i = "",
            ...
            if (
              (this.options.pedantic
                ...
                : l
                  ? (p = n[1].length + 1)
                  : ((p = s.search(this.rules.other.nonSpaceChar)),
                    (p = p > 4 ? 1 : p),
                    (c = s.slice(p)),
                    (p += n[1].length)),
              l &&
                this.rules.other.blankLine.test(u) &&
                ((i += u + "\n"), (e = e.substring(u.length + 1)), (t = !0)),
              !t)
            ) {
              let n = this.rules.other.nextBulletRegex(p),
                t = this.rules.other.hrRegex(p),
                o = this.rules.other.fencesBeginRegex(p),
                a = this.rules.other.headingBeginRegex(p),
                r = this.rules.other.htmlBeginRegex(p),
                d = this.rules.other.blockquoteBeginRegex(p);
              for (; e; ) {
                let f,
                  g = e.split("\n", 1)[0];
                if (
                  ...
                  this.options.pedantic
                    ? ((u = u.replace(
                      ...
                      (f = u))
                    : (f = u.replace(this.rules.other.tabCharGlobal, "    ")),
                  o.test(u) ||
                    a.test(u) ||
                    r.test(u) ||
                    d.test(u) ||
                  ...
                  break;
                if (f.search(this.rules.other.nonSpaceChar) >= p || !u.trim())
                  c += "\n" + f.slice(p);
                else {
                  if (
                    l ||
            ...
            (o.loose ||
              (r
                ? (o.loose = !0)
                : this.rules.other.doubleBlankLine.test(i) && (r = !0)),
              o.items.push({
                type: "list_item",
                raw: i,
          ...
          for (let e of o.items) {
            ...
            let n = e.tokens[0];
            if (!e.task || ("text" !== n?.type && "paragraph" !== n?.type))
              e.task && (e.task = !1);
            else {
              ((e.text = e.text.replace(this.rules.other.listReplaceTask, "")),
                (n.raw = n.raw.replace(this.rules.other.listReplaceTask, "")),
            ...
            if (!o.loose) {
              let n = e.tokens.filter((e) => "space" === e.type),
                t =
                  n.length > 0 &&
                  n.some((e) => this.rules.other.anyLine.test(e.raw));
              o.loose = t;
            }
          }
          if (o.loose)
      ...
      table(e) {
        ...
        if (t.length === i.length) {
          ...
          for (let e = 0; e < t.length; e++)
            a.header.push({
              text: t[e],
              tokens: this.lexer.inline(t[e]),
              header: !0,
              align: a.align[e],
            });
          for (let e of o)
            a.rows.push(
              en(e, a.header.length).map((e, n) => ({
                text: e,
                tokens: this.lexer.inline(e),
                header: !1,
                align: a.align[n],
          ...
          return (
            !this.lexer.state.inLink && this.rules.other.startATag.test(n[0])
              ...
              : this.lexer.state.inLink &&
                this.rules.other.endATag.test(n[0]) &&
                (this.lexer.state.inLink = !1),
            !this.lexer.state.inRawBlock &&
            this.rules.other.startPreScriptTag.test(n[0])
      ...
      link(e) {
        ...
        if (n) {
          ...
          if (
            ...
            let e = (function (e, n) {
              ...
              for (let i = 0; i < e.length; i++)
                ...
                else if (e[i] === n[1] && (t--, t < 0)) return i;
              return t > 0 ? -2 : -1;
            })(n[2], "()");
            if (-2 === e) return;
            if (e > -1) {
              let t = (0 === n[0].indexOf("!") ? 5 : 4) + n[1].length + e;
          ...
          if (this.options.pedantic) {
            let e = this.rules.other.pedanticHrefTitle.exec(t);
            e && ((t = e[1]), (i = e[3]));
      ...
      reflink(e, n) {
        ...
        if (
          ...
          return an(t, e, t[0], this.lexer, this.rules);
        }
      }
      emStrong(e, n, t = "") {
        ...
        if (
          i &&
          (i[1] || i[2] || i[3] || i[4]) &&
          (!i[4] || !t.match(this.rules.other.unicodeAlphaNumeric)) &&
          ((!i[1] && !i[3]) || !t || this.rules.inline.punctuation.exec(t))
        ) {
          let t,
            o,
            a = [...i[0]].length - 1,
          ...
          for (
            s.lastIndex = 0, n = n.slice(-1 * e.length + a);
            null !== (i = s.exec(n));
          ) {
            if (((t = i[1] || i[2] || i[3] || i[4] || i[5] || i[6]), !t))
              continue;
            if (((o = [...t].length), i[3] || i[4])) {
              r += o;
              continue;
            }
            if ((i[5] || i[6]) && a % 3 && !((a + o) % 3)) {
              c += o;
              continue;
            }
            if (((r -= o), r > 0)) continue;
      ...
      codespan(e) {
        ...
        if (n) {
          let e = n[2].replace(this.rules.other.newLineCharGlobal, " "),
            t = this.rules.other.nonSpaceChar.test(e),
            i =
      ...
      del(e, n, t = "") {
        ...
        if (i && (!i[1] || !t || this.rules.inline.punctuation.exec(t))) {
          ...
          for (
            c.lastIndex = 0, n = n.slice(-1 * e.length + a);
            null !== (i = c.exec(n));
          ) {
            if (
      ...
      inlineText(e) {
        ...
        if (n) {
          ...
          return { type: "text", raw: n[0], text: n[0], escaped: e };
        }
      }
    },
    cn = class e {
      ...
      constructor(e) {
        ...
        let n = { other: ne, block: Ve.normal, inline: Qe.normal };
        (this.options.pedantic
          ? ((n.block = Ve.pedantic), (n.inline = Qe.pedantic))
          : this.options.gfm &&
            ((n.block = Ve.gfm),
            this.options.breaks ? (n.inline = Qe.breaks) : (n.inline = Qe.gfm)),
          (this.tokenizer.rules = n));
      }
      static get rules() {
        return { block: Ve, inline: Qe };
      }
      static lex(n, t) {
      ...
      blockTokens(e, n = [], t = !1) {
        ((this.tokenizer.lexer = this),
          this.options.pedantic &&
            (e = e
              .replace(ne.tabCharGlobal, "    ")
              .replace(ne.spaceLine, "")));
        let i = 1 / 0;
        for (; e; ) {
          if (!(e.length < i)) {
          ...
          if (
            ...
            this.options.extensions?.block?.some(
              (t) =>
                !!(o = t.call({ lexer: this }, e, n)) &&
                ((e = e.substring(o.raw.length)), n.push(o), !0),
            ))
          )
            continue;
          if ((o = this.tokenizer.space(e))) {
            ...
            let t = n.at(-1);
            1 === o.raw.length && void 0 !== t ? (t.raw += "\n") : n.push(o);
            continue;
          }
          if ((o = this.tokenizer.code(e))) {
            e = e.substring(o.raw.length);
            let t = n.at(-1);
            "paragraph" === t?.type || "text" === t?.type
              ? ((t.raw += (t.raw.endsWith("\n") ? "" : "\n") + o.raw),
                (t.text += "\n" + o.text),
                (this.inlineQueue.at(-1).src = t.text))
              : n.push(o);
            continue;
          }
      ...
      inlineTokens(e, n = []) {
        ...
        if (this.tokens.links) {
          ...
          if (e.length > 0)
            for (
              ;
              null !== (o = this.tokenizer.rules.inline.reflinkSearch.exec(i));
            )
        ...
        for (
          ;
          null !== (o = this.tokenizer.rules.inline.anyPunctuation.exec(i));
        )
          i =
            i.slice(0, o.index) +
            "++" +
            i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);
        for (; null !== (o = this.tokenizer.rules.inline.blockSkip.exec(i)); )
          ((t = o[2] ? o[2].length : 0),
            (i =
              i.slice(0, o.index + t) +
              "[" +
              "a".repeat(o[0].length - t - 2) +
              "]" +
        ...
        for (; e; ) {
          ...
          if ((t = this.tokenizer.reflink(e, this.tokens.links))) {
            ...
            let i = n.at(-1);
            "text" === t.type && "text" === i?.type
              ? ((i.raw += t.raw), (i.text += t.text))
              : n.push(t);
            continue;
          }
          if ((t = this.tokenizer.emStrong(e, i, r))) {
            ((e = e.substring(t.raw.length)), n.push(t));
            continue;
          }
          ...
          if ((t = this.tokenizer.inlineText(o))) {
            ((e = e.substring(t.raw.length)),
              "_" !== t.raw.slice(-1) && (r = t.raw.slice(-1)),
              (a = !0));
            let i = n.at(-1);
            "text" === i?.type
              ? ((i.raw += t.raw), (i.text += t.text))
      ...
      infiniteLoopError(e) {
        ...
        if (!this.options.silent) throw new Error(n);
        console.error(n);
      }
    },
    sn = class {
      ...
      code({ text: e, lang: n, escaped: t }) {
        let i = (n || "").match(ne.notSpaceStart)?.[0],
          o = e.replace(ne.endingNewline, "") + "\n";
        return i
      ...
      table(e) {
        ...
        for (let n = 0; n < e.rows.length; n++) {
          let o = e.rows[n];
          t = "";
          for (let e = 0; e < o.length; e++) t += this.tablecell(o[e]);
      ...
      image({ href: e, title: n, text: t, tokens: i }) {
        i && (t = this.parser.parseInline(i, this.parser.textRenderer));
        let o = Ke(e);
        if (null === o) return Je(t);
        let a = `<img src="${(e = o)}" alt="${Je(t)}"`;
        return (n && (a += ` title="${Je(n)}"`), (a += ">"), a);
      }
      text(e) {
    ...
    pn = class {
      ...
      provideLexer(e = this.block) {
        return e ? cn.lex : cn.lexInline;
      }
      provideParser(e = this.block) {
        return e ? ln.parse : ln.parseInline;
      }
    },
    dn = new (class {
      defaults = {
      ...
      walkTokens(e, n) {
        ...
        for (let i of e)
          switch (((t = t.concat(n.call(this, i))), i.type)) {
            case "table": {
              let e = i;
              for (let i of e.header)
                t = t.concat(this.walkTokens(i.tokens, n));
              for (let i of e.rows)
                for (let e of i) t = t.concat(this.walkTokens(e.tokens, n));
              break;
            }
            case "list": {
              let e = i;
              t = t.concat(this.walkTokens(e.items, n));
              break;
            }
            default: {
              let e = i;
              this.defaults.extensions?.childTokens?.[e.type]
                ? this.defaults.extensions.childTokens[e.type].forEach((i) => {
                    let o = e[i].flat(1 / 0);
                    t = t.concat(this.walkTokens(o, n));
                  })
                : e.tokens && (t = t.concat(this.walkTokens(e.tokens, n)));
            }
          }
        return t;
      }
        ...
        return (
          e.forEach((e) => {
            ...
            if (
              ...
              e.extensions &&
                (e.extensions.forEach((e) => {
                  ...
                  if ("tokenizer" in e) {
                    ...
                    let t = n[e.level];
                    (t ? t.unshift(e.tokenizer) : (n[e.level] = [e.tokenizer]),
                      e.start &&
                        ("block" === e.level
                          ? n.startBlock
              ...
              let n = this.defaults.renderer || new sn(this.defaults);
              for (let t in e.renderer) {
                ...
                n[i] = (...e) => {
                  let t = o.apply(n, e);
                  return (!1 === t && (t = a.apply(n, e)), t || "");
                };
              }
              t.renderer = n;
            }
            if (e.tokenizer) {
              let n = this.defaults.tokenizer || new rn(this.defaults);
            ...
            if (e.hooks) {
              let n = this.defaults.hooks || new pn();
              for (let t in e.hooks) {
                if (!(t in n)) throw new Error(`hook '${t}' does not exist`);
                if (["options", "block"].includes(t)) continue;
                let i = t,
                  o = e.hooks[i],
                  a = n[i];
                pn.passThroughHooks.has(t)
                  ? (n[i] = (e) => {
                      if (
                        this.defaults.async &&
                        pn.passThroughHooksRespectAsync.has(t)
                      )
                        return (async () => {
                          let t = await o.call(n, e);
                          return a.call(n, t);
                        })();
                      let i = o.call(n, e);
                      return a.call(n, i);
                  ...
                  : (n[i] = (...e) => {
                      if (this.defaults.async)
                        return (async () => {
                          let t = await o.apply(n, e);
                          return (!1 === t && (t = await a.apply(n, e)), t);
                        })();
                      let t = o.apply(n, e);
                      return (!1 === t && (t = a.apply(n, e)), t);
                    });
      ...
      lexer(e, n) {
        return cn.lex(e, n ?? this.defaults);
      }
      parser(e, n) {
        return ln.parse(e, n ?? this.defaults);
      }
      parseMarkdown(e) {
        return (n, t) => {
          let i = { ...t },
          ...
          if (
            ...
            return (async () => {
              let t = o.hooks ? await o.hooks.preprocess(n) : n,
                i = await (
                  o.hooks
                ...
                a = o.hooks ? await o.hooks.processAllTokens(i) : i;
              o.walkTokens &&
                (await Promise.all(this.walkTokens(a, o.walkTokens)));
              let r = await (
                o.hooks
              ...
              return o.hooks ? await o.hooks.postprocess(r) : r;
            })().catch(a);
          try {
            o.hooks && (n = o.hooks.preprocess(n));
            let t = (
              o.hooks ? o.hooks.provideLexer(e) : e ? cn.lex : cn.lexInline
            )(n, o);
            (o.hooks && (t = o.hooks.processAllTokens(t)),
              o.walkTokens && this.walkTokens(t, o.walkTokens));
            let i = (
              o.hooks ? o.hooks.provideParser(e) : e ? ln.parse : ln.parseInline
            )(t, o);
  ...
  function gn(e, n = '<ul class="app-sub-sidebar">{inner}</ul>') {
    if (!e || !e.length) return "";
    let t = "";
    return (
      e.forEach((e) => {
        const n = e.title.replace(/(<([^>]+)>)/g, "");
        let i = `<li><a class="section-link" href="${e.slug}" title="${n}">${e.title}</a></li>`;
        if (e.children) {
          const t = gn(e.children, "<ul>{inner}</ul>");
          i = `<li><a class="section-link" href="${e.slug}" title="${n}">${e.title}</a>${t}</li>`;
        }
        t += i;
      }),
      n.replace("{inner}", t)
    ...
    return (
      e.forEach((e) => {
        const o = e.depth || 1,
          a = o - 1;
        o > n ||
          (i[a] ? (i[a].children = [...(i[a].children || []), e]) : t.push(e),
          (i[o] = e));
      }),
      t
    );
  ...
  ((fn.options = fn.setOptions =
    ...
    (fn.defaults = Y),
    (fn.use = function (...e) {
      return (dn.use(...e), (fn.defaults = dn.defaults), X(fn.defaults), fn);
    }),
    (fn.walkTokens = function (e, n) {
      return dn.walkTokens(e, n);
    }),
    (fn.parseInline = dn.parseInline),
    (fn.Parser = ln),
    (fn.parser = ln.parse),
    (fn.Renderer = sn),
    (fn.TextRenderer = un),
  ...
  function kn(e) {
    ...
    let n = e
      ...
      t = mn[n];
    return (
      (t = Object.keys(mn).includes(n) ? t + 1 : 0),
      (mn[n] = t),
      t && (n = n + "-" + t),
      n
    );
  ...
  function yn(e, n) {
    return e
      .replace(
        ...
        (e) => e.replace(/:/g, "__colon__"),
      )
      .replace(/<!--[\s\S]+?-->/g, (e) => e.replace(/:/g, "__colon__"))
      .replace(/([a-z]{2,}:)?\/\/[^\s'">)]+/gi, (e) =>
        e.replace(/:/g, "__colon__"),
      )
      .replace(/:([a-z0-9_\-+]+?):/g, (e, t) =>
        (function (e, n, t) {
          const i = wn.data[n];
          let o = e;
          i &&
            (o =
              t && /unicode/.test(i)
                ? `<span class="emoji">${i
                    ...
                    .join("&zwj;")
                    .concat("&#xFE0E;")}</span>`
                : `<img src="${wn.baseURL}${i}.png" alt="${n}" class="emoji" loading="lazy">`);
          return o;
        })(e, t, n),
      )
      .replace(/__colon__/g, ":");
    ...
    return (
      e &&
        (e = e
          .replace(/^('|")/, "")
          .replace(/('|")$/, "")
          .replace(/(?:^|\s):([\w-]+:?)=?([\w-%]+)?/g, (e, t, i) =>
            -1 !== t.indexOf(":")
              ? e
              : (!0 !== (i = (i && i.replace(/&quot;/g, "")) || !0) &&
                void 0 !== n[t]
                  ? (Array.isArray(n[t]) || i === n[t] || (n[t] = [n[t]]),
  ...
  function $n(e) {
    ...
    return String(e).replace(/[&<>"']/g, (e) => n[e]);
  }
  const Sn = ({ renderer: e, router: n, compiler: t }) =>
    (e.heading = function ({ tokens: e, depth: i, text: o }) {
      const a = this.parser.parseInline(e);
      let { str: r, config: c } = xn(a);
      const s = { depth: i, title: r },
        {
          content: u,
          ignoreAllSubs: l,
          ignoreSubHeading: p,
          ...
          let n, t;
          return (
            /<!-- {docsify-ignore} -->/g.test(e) &&
              ((e = e.replace("\x3c!-- {docsify-ignore} --\x3e", "")),
              (t = !0)),
            /{docsify-ignore}/g.test(e) &&
              ((e = e.replace("{docsify-ignore}", "")), (t = !0)),
            /<!-- {docsify-ignore-all} -->/g.test(e) &&
              ((e = e.replace("\x3c!-- {docsify-ignore-all} --\x3e", "")),
              (n = !0)),
            /{docsify-ignore-all}/g.test(e) &&
              ((e = e.replace("{docsify-ignore-all}", "")), (n = !0)),
            { content: e, ignoreAllSubs: n, ignoreSubHeading: t }
          );
        })(r);
      ((r = u.trim()),
        (s.title = (function (e = "") {
          return e.replace(/(<\/?a.*?>)/gi, "");
        })(r)),
        (s.ignoreAllSubs = l),
        (s.ignoreSubHeading = p));
      const d = kn(c.id || o),
        f = n.toURL(n.getCurrentPath(), { id: d });
      return (
        (s.slug = j(f)),
        0 === t.blockquoteDepth && t.toc.push(s),
        `<h${i} id="${d}" tabindex="-1"><a href="${f}" data-id="${d}" class="anchor"><span>${r}</span></a></h${i}>`
      );
    });
  !(function (e) {
    function n(e, n) {
        ...
        value: function (t, i, o, a) {
          if (t.language === i) {
            ...
            ((t.code = t.code.replace(o, function (e) {
              ...
              for (var o, c = r.length; -1 !== t.code.indexOf((o = n(i, c))); )
                ++c;
              return ((r[c] = e), o);
            })),
      ...
      tokenizePlaceholders: {
        value: function (t, i) {
          if (t.language === i && t.tokenStack) {
            ...
            !(function r(c) {
              for (var s = 0; s < c.length && !(o >= a.length); s++) {
                var u = c[s];
                if (
                  "string" == typeof u ||
                  ...
                  if (g > -1) {
                    ...
                    var v = d.substring(0, g),
                      ...
                      m = d.substring(g + f.length),
                      _ = [];
                    (v && _.push.apply(_, r([v])),
                      _.push(h),
                      m && _.push.apply(_, r([m])),
                      "string" == typeof u
                        ? c.splice.apply(c, [s, 1].concat(_))
                        : (u.content = _));
                  }
  ...
  const Rn = (e, n, t) => {
      if (!e) return;
      const i = { cur: e, loaded: !0, dependencies: [] };
      let o = An[e] || [];
      (e in S.languages || ((t.loaded = !1), (i.loaded = !1)),
        "string" == typeof o && (o = [o]),
        o.forEach((e) => {
          Rn(e, i, t);
        }),
        n.dependencies.push(i));
    },
    Ln = (e, n) => {
      let t = `${"  ".repeat(3 * n)} ${e.cur} ${e.loaded ? "(+)" : "(-)"}`;
      return (
    ...
    jn = ({ renderer: e }) =>
      (e.code = function ({ text: e, lang: n = "markup" }) {
        const { escapedLang: t, prismLang: i } = ((e) => {
          const n =
            "string" == typeof e && e.trim().length ? e.trim() : "markup";
          return { codeLang: n, prismLang: En[n] || n, escapedLang: $n(n) };
        })(n);
        !(function (e) {
          if (!e) return;
          if (An[(e = En[e] || e)] && !Tn[e]) {
            const n = { loaded: !0, dependencies: [] };
            Rn(e, n, n);
            const t = n.dependencies[0];
            if (((Tn[e] = t), !n.loaded)) {
              const n = Ln(t, 1);
              console.warn(
                `The language '${e}' required dependencies for code block highlighting are not satisfied.`,
        ...
        const o = S.languages[i] || S.languages.markup;
        return `<pre data-lang="${t}" class="language-${t}"><code class="lang-${t} language-${t}" tabindex="0">${S.highlight(e.replace(/@DOCSIFY_QM@/g, "`"), o, i)}</code></pre>`;
      });
  function Cn(e) {
    return e.startsWith("!&gt;")
      ? vn("callout important", e)
      : e.startsWith("?&gt;")
        ? vn("callout tip", e)
        : `<p>${e}</p>`;
  }
  const zn = ({ renderer: e }) =>
      (e.paragraph = function ({ tokens: e, embedTokenMap: n }) {
        let t;
        if (n && e?.length) {
          const i = [];
          let o = [];
          const a = () => {
            if (!o.length) return;
            const e = this.parser.parseInline(o);
            (i.push(Cn(e)), (o = []));
          };
          (e.forEach((e, t) => {
            const r = n[t];
            r?.length ? (a(), i.push(this.parser.parse(r))) : o.push(e);
          }),
            a(),
            (t = i.join("")));
        } else {
          t = Cn(this.parser.parseInline(e));
        }
        return t;
      }),
    qn = ({ renderer: e, compiler: n }) =>
      (e.blockquote = function ({ tokens: e }) {
        let t = "<blockquote>",
          i = "</blockquote>";
        const o = e.findIndex((e) => "paragraph" === e.type),
          a = e[o];
        if (a) {
          const n = a.raw.match(/^(\[!(\w+)\])/);
          if (n) {
            const r = n[1],
              c = n[2].toLowerCase();
            e = e.slice();
            const s = { ...a };
            (a.tokens && (s.tokens = a.tokens.map((e) => ({ ...e }))),
              (e[o] = s),
              (s.raw = s.raw.replace(r, "").trimStart()),
              s.tokens &&
                s.tokens.length > 0 &&
                s.tokens.forEach((e) => {
                  (e.raw && (e.raw = e.raw.replace(r, "")),
                    e.text && (e.text = e.text.replace(r, "")));
                }),
              s.raw.trim() || e.splice(o, 1),
              (t = `<div class="callout ${c}">`),
              (i = "</div>"));
          }
        }
        n.blockquoteDepth++;
    ...
    Fn = ({ renderer: e }) =>
      (e.list = function (e) {
        ...
        const o = n ? "ol" : "ul";
        return `<${o} ${[/<li class="task-list-item">/.test(i.split('class="task-list"')[0]) ? 'class="task-list"' : "", t && t > 1 ? `start="${t}"` : ""].join(" ").trim()}>${i}</${o}>`;
      }),
    Pn = ({ renderer: e }) =>
      (e.listitem = function (e) {
        ...
        return /^(<input.*type="checkbox"[^>]*>)/.test(n)
          ? `<li class="task-list-item"><label>${n}</label></li>`
          : `<li>${n}</li>`;
      }),
    Mn = ({ renderer: e, router: n, linkTarget: t, linkRel: i, compiler: o }) =>
      (e.link = function ({ href: e, title: a = "", tokens: r }) {
        const c = [],
          s = this.parser.parseInline(r) || "",
          { str: u, config: l } = xn(a),
          p = C(e),
          d = o._matchNotCompileLink(e),
          f = e.startsWith("mailto:");
        if (
          ((t = l.target || t),
          (i = "_blank" === t ? o.config.externalLinkRel || "noopener" : ""),
          (a = u),
          p || d || l.ignore
            ? (!p &&
                e.startsWith("./") &&
                (e = n.toURL(e, null, n.getCurrentPath()).replace(/^#\//, "/")),
              f || (c.push(`target="${t}"`), "" !== i && c.push(`rel="${i}"`)))
            : (e === o.config.homepage && (e = "README"),
              (e = n.toURL(e, null, n.getCurrentPath())),
              l.target && !f && c.push(`target="${t}"`)),
          l.disabled && (c.push("disabled"), (e = "javascript:void(0)")),
          l.class)
        ) {
          let e = l.class;
          (Array.isArray(l.class) && (e = l.class.join(" ")),
            c.push(`class="${e}"`));
        }
        return (
          l.id && c.push(`id="${l.id}"`),
          a && c.push(`title="${$n(a)}"`),
          `<a href="${$n(e)}" ${c.join(" ")}>${s}</a>`
        );
      }),
    On = {
      markdown: (e) => ({ url: e }),
      mermaid: (e) => ({ url: e }),
      iframe: (e, n) => ({
        html: `<iframe src="${$n(e)}" ${n || "width=100% height=400"}></iframe>`,
      }),
      video: (e, n) => ({
        html: `<video src="${$n(e)}" ${n || "controls"}>Not Supported</video>`,
      }),
      audio: (e, n) => ({
        html: `<audio src="${$n(e)}" ${n || "controls"}>Not Supported</audio>`,
      }),
      code(e, n) {
        let t = e.match(/\.(\w+)$/);
        return (
    ...
    In = ({ renderer: e }) =>
      (e.tablecell = function (e) {
        let n;
        e.embedTokenMap && e.tokens?.length
          ? ((n = ""),
            e.tokens.forEach((t, i) => {
              const o = e.embedTokenMap[i];
              n += o?.length
                ? this.parser.parse(o)
                : this.parser.parseInline([t]);
            }))
          : (n =
              e.embedTokens && e.embedTokens.length > 0
                ? this.parser.parse(e.embedTokens)
                : this.parser.parseInline(e.tokens));
  ...
  class Bn {
    constructor(e, t) {
      ...
      ((this.config = e),
        ...
        (this.cacheTOC = {}),
        (this.linkTarget = e.externalLinkTarget || "_blank"),
        (this.linkRel =
          "_blank" === this.linkTarget ? e.externalLinkRel || "noopener" : ""),
        (this.contentBase = t.getBasePath()),
        (this.renderer = this._initRenderer()));
      const r = e.markdown || {};
      (a(r)
        ? (o = r(fn, this.renderer))
        : (fn.setOptions(
            Object.assign(r, {
              renderer: Object.assign(this.renderer, r.renderer),
            }),
          ),
          (o = fn)),
        (this._marked = o),
        (this.compile = (t) => {
          ...
          const r = n((n) => {
              ...
              let r = "";
              return t
                ? ((r = i(t) ? o(t) : o.parser(t)),
                  (r = e.noEmoji ? r : yn(r, e.nativeEmoji)),
                  kn.clear(),
                  r)
                : t;
            })(t),
            c = this.router.parse().file;
          return (
            a
              ? (this.toc = this.cacheTOC[c])
              : (this.cacheTOC[c] = [...this.toc]),
            r
          );
        }));
    }
    compileEmbed(e, n) {
      const { str: t, config: i } = xn(n);
      let o;
      if (((n = t), i.include)) {
        let t;
        C(e) || (e = O(this.contentBase, q(this.router.getCurrentPath()), e));
        const a = Array.isArray(i.type) ? i.type[0] : i.type;
        if (a && (t = On[a])) ((o = t.call(this, e, n)), (o.type = a));
        else {
          let t = "code";
          (/\.(md|markdown)/.test(e)
            ? (t = "markdown")
        ...
        return (
          (o.fragment = i.fragment),
          (o.omitFragmentLine = i.omitFragmentLine),
          o
        );
      }
    }
    _matchNotCompileLink(e) {
      ...
      for (const t of n) {
        if ((Nn[t] || (Nn[t] = new RegExp(`^${t}$`))).test(e)) return e;
      }
    }
    _initRenderer() {
      const e = new fn.Renderer(),
        { linkTarget: n, linkRel: t, router: i, contentBase: o } = this,
        a = {};
      return (
        (a.heading = Sn({ renderer: e, router: i, compiler: this })),
        (a.blockquoteCompiler = qn({ renderer: e, compiler: this })),
        (a.code = jn({ renderer: e })),
        (a.link = Mn({
          renderer: e,
          router: i,
          linkTarget: n,
        ...
        (a.paragraph = zn({ renderer: e })),
        (a.image = (({ renderer: e, contentBase: n, router: t }) =>
          (e.image = ({ href: e, title: i, text: o }) => {
            let a = e;
            const r = [],
              { str: c, config: s } = xn(i);
            if (
              ((i = c),
              s["no-zoom"] && r.push("data-no-zoom"),
              i && r.push(`title="${$n(i)}"`),
              s.size)
            ) {
              const [e, n] = s.size.split("x");
              n ? r.push(`width="${e}" height="${n}"`) : r.push(`width="${e}"`);
            }
            if (s.class) {
              let e = s.class;
              (Array.isArray(s.class) && (e = s.class.join(" ")),
                r.push(`class="${e}"`));
            }
            return (
              s.id && r.push(`id="${s.id}"`),
              C(e) || (a = O(n, q(t.getCurrentPath()), e)),
              `<img src="${$n(a)}" data-origin="${$n(e)}" alt="${$n(o)}" ${r.join(" ")} />`
            );
          }))({ renderer: e, contentBase: o, router: i })),
        (a.list = Fn({ renderer: e })),
        (a.listitem = Pn({ renderer: e })),
        (a.tablecell = In({ renderer: e })),
        (e.origin = a),
        e
      );
    }
    sidebar(e, n) {
      const { toc: t } = this,
        i = this.router.getCurrentPath();
      let o = "";
      if (e) return this.compile(e);
      for (let e = 0; e < t.length; e++)
        if (t[e].ignoreSubHeading) {
          const n = t[e].depth;
          for (t.splice(e, 1); e < t.length && t[e].depth > n; ) t.splice(e, 1);
          e--;
        }
      const a = this.cacheTree[i] || hn(t, n);
      return ((o = gn(a)), (this.cacheTree[i] = a), o);
    }
    resetToc() {
      this.toc = [];
    }
    subSidebar(e) {
      const n = this.router.getCurrentPath(),
        { cacheTree: t, toc: i } = this;
      (i[0] && i[0].ignoreAllSubs && i.splice(0),
        i[0] && 1 === i[0].depth && i.shift());
      for (let e = 0; e < i.length; e++)
        i[e].ignoreSubHeading && i.splice(e, 1) && e--;
      const o = t[n] || hn(i, e);
      return ((t[n] = o), (this.toc = []), gn(o));
    }
    header(e, n) {
      const t = {
        type: "heading",
      ...
      return this.renderer.heading(t);
    }
    cover(e) {
      const n = this.toc.slice(),
        t = this.compile(e);
      return ((this.toc = n.slice()), t);
    }
  }
  var Dn,
    Hn,
    ...
    Zn =
      ...
      (Hn = ["", ""]),
      Object.freeze(
        Object.defineProperties(Dn, { raw: { value: Object.freeze(Hn) } }),
      ));
  var Gn = (function () {
      function e() {
        for (
          var n = this, t = arguments.length, i = Array(t), o = 0;
          o < t;
          o++
        )
          i[o] = arguments[o];
        return (
          ...
          (this.tag = function (e) {
            for (
              ...
              i[o - 1] = arguments[o];
            return "function" == typeof e
              ? n.interimTag.bind(n, e)
              : "string" == typeof e
                ? n.transformEndResult(e)
                : ((e = e.map(n.transformString.bind(n))),
                  n.transformEndResult(
                    e.reduce(n.processSubstitutions.bind(n, i)),
                  ));
          }),
        ...
        Un(e, [
          {
            ...
            value: function (e, n) {
              for (
                var t = arguments.length, i = Array(t > 2 ? t - 2 : 0), o = 2;
                o < t;
                o++
              )
                i[o - 2] = arguments[o];
              return this.tag(Zn, e.apply(void 0, [n].concat(i)));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, n) {
              return this.transformers.reduce(function (e, t) {
                return t.onSubstitution ? t.onSubstitution(e, n) : e;
              }, e);
            },
          },
          {
    ...
    Yn = function (e, n) {
      return {
        onSubstitution: function (t, i) {
          ...
          return null == t ? t : t.toString().replace(e, n);
        },
      };
    },
    Xn = { separator: "", conjunction: "", serial: !1 },
    Jn = function () {
      var e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Xn;
      return {
        onSubstitution: function (n, t) {
          if (Array.isArray(n)) {
            var i = n.length,
              o = e.separator,
              a = e.conjunction,
              r = e.serial,
              c = t.match(/(\n?[^\S\n]+)$/);
            if (((n = c ? n.join(o + c[1]) : n.join(o + " ")), a && i > 1)) {
              var s = n.lastIndexOf(o);
              n = n.slice(0, s) + (r ? o : "") + " " + a + n.slice(s + 1);
            }
          }
          return n;
        },
  ...
  (new Gn(Jn({ separator: "," }), Vn, Wn),
    new Gn(Jn({ separator: ",", conjunction: "and" }), Vn, Wn),
    new Gn(Jn({ separator: ",", conjunction: "or" }), Vn, Wn),
    new Gn(
      Kn("\n"),
      function () {
        return {
          onSubstitution: function (e) {
            return Array.isArray(e) ? e.filter(et) : et(e) ? e : "";
          },
        };
      },
      Jn,
    ...
    new Gn(Qn(/(?:\n(?:\s*))+/g, " "), Wn),
    new Gn(Qn(/(?:\n\s*)/g, ""), Wn),
    new Gn(Jn({ separator: "," }), Qn(/(?:\s+)/g, " "), Wn),
    new Gn(Jn({ separator: ",", conjunction: "or" }), Qn(/(?:\s+)/g, " "), Wn),
    new Gn(Jn({ separator: ",", conjunction: "and" }), Qn(/(?:\s+)/g, " "), Wn),
    new Gn(Jn, Vn, Wn),
    new Gn(Jn, Qn(/(?:\s+)/g, " "), Wn));
  var nt = new Gn(Vn, Wn);
  let tt, it;
  function ot(e) {
    const { loaded: n, total: t, step: i } = e;
    let o;
    (!tt &&
      (function () {
        const e = v("div");
        (e.classList.add("progress"),
          ...
          e.setAttribute("aria-label", "Loading..."),
          h(p, e),
          (tt = e));
      })(),
      void 0 !== i
        ? ((o = parseInt(tt.style.width || 0, 10) + i), (o = o > 80 ? 80 : o))
        : (o = Math.floor((n / t) * 100)),
      (tt.style.opacity = 1),
      (tt.style.width = o >= 95 ? "100%" : o + "%"),
      tt.setAttribute("aria-valuenow", o >= 95 ? 100 : o),
      o >= 95 &&
        (clearTimeout(it),
        (it = setTimeout((e) => {
          ((tt.style.opacity = 0),
            (tt.style.width = "0%"),
            tt.removeAttribute("aria-valuenow"));
        }, 200))));
  }
  new Gn(Vn("all"), Wn);
  const at = {};
  function rt(e, n = !1, t = {}) {
    const i = new XMLHttpRequest(),
      a = at[e];
    if (a) return { then: (e) => e(a.content, a.opt), abort: o };
    i.open("GET", e);
    for (const e of Object.keys(t)) i.setRequestHeader(e, t[e]);
    return (
      i.send(),
      {
        then(t, a = o) {
          ...
          if (n) {
            const e = setInterval(
              (e) => ot({ step: Math.floor(5 * Math.random() + 1) }),
              500,
            );
            (i.addEventListener("progress", ot),
              i.addEventListener("loadend", (n) => {
                (ot(n), clearInterval(e));
              }));
          }
          (i.addEventListener("error", (e) => {
            ...
            i.addEventListener("load", (n) => {
              ...
              if (o.status >= 400) a(n, r(n));
                ...
                t(a.content, a.opt, r(n));
              }
            }));
        },
        abort: (e) => 4 !== i.readyState && i.abort(),
      }
    );
  }
  const ct = {};
  ...
  function ut({ compiler: e, raw: n = "", fetch: t }, i) {
    const o = ct[n];
    if (o) {
      const e = o.slice();
      return ((e.links = o.links), i(e));
    }
    const a = e._marked,
      r = e.config.frontMatter;
    let c = a.lexer(n);
    const s = [],
      u = c.links;
    c.forEach((n, t) => {
      "paragraph" === n.type
        ? (n.tokens || []).forEach((i, o) => {
            if ("link" !== i.type) return;
            const a = e.compileEmbed(i.href, i.title);
            a && s.push({ index: t, tokenRef: n, inlineIndex: o, embed: a });
          })
        : "table" === n.type &&
          n.rows.forEach((i, o) => {
            i.forEach((i, a) => {
              (i.tokens || []).forEach((i, r) => {
                if ("link" !== i.type) return;
                const c = e.compileEmbed(i.href, i.title);
                c &&
                  s.push({
                    index: t,
                    tokenRef: n,
    ...
    const l = [],
      p = new WeakMap();
    !(function ({ embedTokens: e, compile: n, fetch: t, frontMatter: i }, o) {
      ...
      const a = (t) => {
        const r = e[t],
          c = (c) => {
            let s;
            if (c)
              if ("markdown" === r.embed.type) {
                let e = r.embed.url.split("/");
                (e.pop(),
                  (e = e.join("/")),
                  (c = c.replace(/\[([^[\]]+)\]\(([^)]+)\)/g, (n) => {
                    const t = n.indexOf("(");
                    return "(." === n.slice(t, t + 2)
                      ? n.substring(0, t) +
                          `(${window.location.protocol}//${window.location.host}${e}/` +
                          n.substring(t + 1, n.length - 1) +
                          ")"
                      : n;
                  })));
                const t = i?.installed;
                (t && (c = i?.parseMarkdown(c)),
                  r.embed.fragment &&
                    (c = st(c, r.embed.fragment, r.embed.omitFragmentLine)),
                  (s = n.lexer(c)));
              } else
                "code" === r.embed.type
                  ? (r.embed.fragment &&
            ...
            (o({
              ...
              t + 1 >= e.length ? o({}) : a(t + 1));
          };
        r.embed.url ? rt(r.embed.url).then(c, () => c()) : c(r.embed.html);
      };
      a(0);
    })(
      { compile: a, embedTokens: s, fetch: t, frontMatter: r },
      ({ embedToken: e, token: t, rowIndex: o, cellIndex: a, tokenRef: r }) => {
        if (t && e)
          if (
            (Object.assign(u, e.links),
            "number" == typeof o && "number" == typeof a)
          ) {
            const n = r.rows[o][a];
            if ("number" == typeof t.inlineIndex) {
              n.embedTokenMap ||= {};
              const i = n.embedTokenMap[t.inlineIndex];
              n.embedTokenMap[t.inlineIndex] = i ? i.concat(e) : e;
            }
            n.embedTokens && n.embedTokens.length
              ? (n.embedTokens = n.embedTokens.concat(e))
              : (n.embedTokens = e);
          } else if ("paragraph" === r.type) {
            if ("number" == typeof t.inlineIndex) {
              r.embedTokenMap ||= {};
              const n = r.embedTokenMap[t.inlineIndex];
              r.embedTokenMap[t.inlineIndex] = n ? n.concat(e) : e;
            }
            r.embedTokens && r.embedTokens.length
              ? (r.embedTokens = r.embedTokens.concat(e))
              : (r.embedTokens = e);
          } else {
            const n = p.get(r);
            if (n) {
              const t = n.nextIndex;
              ((c = c.slice(0, t).concat(e, c.slice(t))),
                l.push({ start: t, delta: e.length }),
                (n.nextIndex = t + e.length));
            } else {
              let n = t.index;
              (l.forEach((e) => {
                n > e.start && (n += e.delta);
              }),
                (c = c.slice(0, n).concat(e, c.slice(n + 1))),
                l.push({ start: n, delta: e.length - 1 }),
                p.set(r, { nextIndex: n + e.length }));
            }
          }
        else t || ((ct[n] = c.concat()), (c.links = ct[n].links = u), i(c));
      },
    );
  }
  function lt(e) {
    return class extends e {
      ...
      #o(e) {
        g(e).forEach((e) => {
          const n = e;
          !n.title && n.innerText && (n.title = n.innerText);
        });
      }
      #a() {
        const e = g(".markdown-section>script").filter(
          (e) => !/template/.test(e.type),
        )[0];
        if (!e) return !1;
          ...
          (n =
            "function" == typeof t
              ...
              : "string" == typeof t
                ? ((o = []),
                  (a = 0),
                  (i = t).replace(Z, function (e, n, t) {
                    (o.push(i.substring(a, t - 1)),
                      (a = t += e.length + 1),
                      o.push(function (n) {
                        return (
                          "00" + ("string" == typeof G[e] ? n[G[e]]() : G[e](n))
                        ).slice(-e.length);
                      }));
                  }),
                  a !== i.length && o.push(i.substring(a)),
                  function (e) {
                    for (
                      var n = "", t = 0, i = e || new Date();
                      t < o.length;
                      t++
                    )
                      n += "string" == typeof o[t] ? o[t] : o[t](i);
                    return n;
                  })(new Date(n))
                : n),
      ...
      #c(e) {
        const n = this.config,
          t = f(".markdown-section"),
          i =
            "Vue" in window &&
            window.Vue.version &&
            Number(window.Vue.version.charAt(0)),
          o = (e) => {
            const n = Boolean(e.__vue__ && e.__vue__._isVue),
              t = Boolean(e._vnode && e._vnode.__v_skip);
            return n || t;
          };
        if ("Vue" in window) {
          const e = g(".markdown-section > *").filter((e) => o(e));
          for (const n of e)
            2 === i
              ? n.__vue__?.$destroy?.()
              : 3 === i && n.__vue_app__?.unmount();
        }
        if (
          (u(t, e),
          ...
          const e = n.vueGlobalOptions || {},
            a = [],
            r = Object.keys(n.vueComponents || {});
          (2 === i &&
            r.length &&
            r.forEach((e) => {
          ...
          if (
            (a.push(
              ...g(".markdown-section > *")
                .filter((e) => !a.some(([n, t]) => n === e))
                .filter((e) => {
                  const t = r.join(","),
                    i = !!t && Boolean(e.querySelector(t));
                  return (
                ...
                .map((n) => {
                  const t = { ...e };
                  return (this.#i && (t.data = () => this.#i), [n, t]);
                }),
            ),
            0 === a.length)
          )
          ...
          for (const [e, t] of a) {
            ...
            if (
              !(
                e.matches("pre, :not([v-template]):has(pre), script") ||
                o(e) ||
                e.querySelector(`[${a}]`)
              )
            )
              if ((e.setAttribute(a, ""), 2 === i))
                ((t.el = void 0), new window.Vue(t).$mount(e));
              else if (3 === i) {
                const i = window.Vue.createApp(t);
                (r.forEach((e) => {
                  const t = n.vueComponents[e];
                  i.component(e, t);
                }),
                  i.mount(e));
              }
      ...
      #s(e) {
        const n = s(".app-name-link"),
          t = e.config.nameLink,
          o = e.route.path;
        if (n)
          if (i(e.config.nameLink)) n.setAttribute("href", t);
      ...
      #u(e) {
        ...
        if (!1 !== n) {
          const t = s("#skip-to-content");
          let i = "string" == typeof n ? n : "Skip to main content";
          if (n?.constructor === Object) {
            const t = Object.keys(n).find((n) =>
              e.route.path.startsWith(n.startsWith("/") ? n : `/${n}`),
            );
            i = (t && n[t]) || i;
          }
          if (t) t.innerHTML = i;
          else {
            const e = `<button type="button" id="skip-to-content" class="primary">${i}</button>`;
            p.insertAdjacentHTML("afterbegin", e);
          }
        }
      }
      _renderSidebar(e) {
        const {
          ...
          a = s("aside.sidebar"),
          r = s(".sidebar-nav"),
          c = s("button.sidebar-toggle");
        if (o) return (a?.remove(), c?.remove(), null);
        if (!this.compiler) throw new Error("Compiler is not initialized");
        (u(".sidebar-nav", this.compiler.sidebar(e, n)),
          c.setAttribute("aria-expanded", String(!V())));
        const l = f(
          `.sidebar-nav a[href="${decodeURIComponent(this.router.toURL(this.route.path))}"]`,
        );
        if ((this.#o(".sidebar-nav a"), i && l)) {
          l.parentElement.innerHTML += this.compiler.subSidebar(t) || "";
        } else this.compiler.resetToc();
        this._bindEventOnRendered(l);
        const p = g(
            r,
          ...
          d = g(a, "li").filter(
            (e) =>
              e.querySelector(":scope > ul") &&
              !e.querySelectorAll(":scope > a, :scope > p > a").length,
          );
        (p.forEach((e) => {
      ...
      _bindEventOnRendered(e) {
        ...
        if ((this.onRender(), n && e)) {
          const n = s("#main");
          if (!n.querySelector("h1")) {
            const t = v(
              "div",
              this.compiler.header(e.innerText, 1),
            ).firstElementChild;
            t && m(n, t);
          }
        }
      ...
      _renderNav(e) {
        if (!e) return;
        const n = this.compiler.compile(e);
        [".app-nav", ".app-nav-merged"].forEach((e) => {
          (u(e, n), this.#o(`${e} a`));
        });
      }
      _renderMain(e, n = {}, t) {
        const { response: i } = this.route;
        (!i ||
          i.ok ||
          (e && 404 === i.status) ||
          (e = `# ${i.status} - ${i.statusText}`),
          this.callHook("beforeEach", e, (i) => {
            let o;
            const a = () => {
              (n.updatedAt &&
                (o = this.#r(o, n.updatedAt, this.config.formatUpdated)),
                this.callHook("afterEach", o, (e) => {
                  (this.#c(e), t());
                }));
            };
            this.isHTML
              ? ((o = this.result = e), a())
              : ut({ compiler: this.compiler, raw: i, fetch: void 0 }, (e) => {
      ...
      _renderCover(e, n) {
        const t = s(".cover"),
          ...
          o = getComputedStyle(i).getPropertyValue("--cover-bg");
        if ((s("main").classList[n ? "add" : "remove"]("hidden"), !e))
          return void t.classList.remove("show");
        t.classList.add("show");
        let a = this.coverIsHTML ? e : this.compiler.cover(e);
        if (!o) {
          const e = a
            .trim()
            .match(
          ...
          if (e) {
            ...
            if ("color" === o) n = i;
              ...
              n = `center center / cover url(${C(i) ? i : O(this.router.getBasePath(), i)})`;
            }
            a = a.replace(t, "");
          } else {
            const e = Math.round((120 * Math.random()) / 2);
            let t = Math.round(360 * Math.random()),
              i = Math.round(360 * Math.random());
            if (Math.abs(t - i) < 50) {
              const e = Math.round(25 * Math.random()) + 25;
              ((t = Math.max(t, i) + e), (i = Math.min(t, i) - e));
            }
          ...
          i.style.setProperty("--cover-bg", n);
        }
        (u(".cover-main", a),
          g(".cover-main > p:last-of-type > a:not([class])").forEach((e) => {
            const n = e.matches(":first-child") ? "primary" : "secondary";
            e.classList.add("button", n);
          }));
      }
      _updateRender() {
        (this.#s(this), this.#u(this));
      }
      initRender() {
        const e = this.config;
        ((this.compiler = new Bn(e, this.router)),
        ...
        if (e.loadNavbar) {
          const n = f("nav") || v("nav"),
            t = e.mergeNavbar;
          if (
            (n.classList.add("app-nav"),
            n.setAttribute("aria-label", "secondary"),
            p.prepend(n),
            t)
          ) {
            const e = v("div"),
              n = f(".sidebar"),
              t = f(".sidebar-nav");
            (e?.classList.add("app-nav-merged"), n?.insertBefore(e, t));
          }
        }
        if (e.themeColor) {
          const n = v(
            "div",
            ((o = e.themeColor), `<style>:root{--theme-color: ${o};}</style>`),
          ).firstElementChild;
          n && l.head.appendChild(n);
        }
        (this._updateRender(), p.classList.add("ready"));
      }
    };
  }
  function pt(e) {
    return class extends e {
      ...
      initEvent() {
        ...
        if (e) {
          const n = "number" == typeof e ? `${e}px` : e;
          document.documentElement.style.setProperty("--scroll-padding-top", n);
        }
        (this.#g(), this.#v(), this.#h(), this.#m(), this.#_());
      }
      #g() {
        const e = f("section.cover");
        if (!e) return void p.classList.add("sticky");
        new IntersectionObserver(
          (e) => {
            const n = e[0].isIntersecting ? "remove" : "add";
            p.classList[n]("sticky");
          },
          { threshold: 0.01 },
        ).observe(e);
      }
      #b() {
        const e = g("#main :where(h1, h2, h3, h4, h5, h6)"),
          n = new Set();
        let t = !0;
        (this.#l?.disconnect(),
          (this.#l = new IntersectionObserver(
            (e) => {
              if (t) return void (t = !1);
              if (this.#p) return;
              for (const t of e) {
                const e = t.isIntersecting ? "add" : "delete";
                n[e](t.target);
              }
              let i;
              if (
                ...
                const e = i.getAttribute("id"),
                  n = this.router.toURL(this.router.getCurrentPath(), {
                    id: e,
                  }),
                  t = this.#k(n);
                t?.scrollIntoView({
      ...
      #_() {
        const { keyBindings: e } = this.config,
          n = ["alt", "ctrl", "meta", "shift"];
        e &&
          e.constructor === Object &&
          (Object.values(e || []).forEach((e) => {
            const { bindings: t } = e;
            t &&
              ((e.bindings = Array.isArray(t) ? t : [t]),
              (e.bindings = e.bindings.map((e) => {
                const t = [[], []];
                return (
              ...
              .filter(
                ({ bindings: e }) =>
                  ...
                  e.some((e) =>
                    e.every(
                      (e) =>
                        (n.includes(e) && t[e + "Key"]) ||
                        t.key === e ||
                        t.code.toLowerCase() === e ||
                        t.code.toLowerCase() === `key${e}`,
                    ),
                  ),
              )
              .forEach(({ callback: e }) => {
      ...
      #h() {
        ...
        e &&
          ...
          _(e, "click", ({ target: e }) => {
            const n = e.closest("a"),
              t = n?.closest("li"),
              i = t?.querySelector(".app-sub-sidebar");
            i && t.classList.toggle("collapse");
          }));
      }
      #m() {
        const e = f("main > .content"),
          n = f("button.sidebar-toggle");
        if (!n) return;
        let t;
        (_(e, "focusin", (e) => {
          const n = "data-restore-focus";
          (t?.removeAttribute(n), (t = e.target), t.setAttribute(n, ""));
        }),
          _(n, "click", (e) => {
            (e.stopPropagation(), this.#w());
          }));
      }
      #v() {
        const e = document.querySelector("#skip-to-content");
        e &&
          e.addEventListener("click", (e) => {
            const n = this.#y();
            (e.preventDefault(), n?.scrollIntoView({ behavior: "smooth" }));
          });
      }
      onRender() {
        const { name: e, pageTitleFormatter: n } = this.config,
          t = this.router.toURL(this.router.getCurrentPath()),
          i = f(`.sidebar a[href='${t}']`)?.getAttribute("title"),
          o =
            "function" == typeof n && "string" == typeof e
              ? n(e)
              : e
                ? e.replace(/<[^>]+>/g, "").trim()
                : e,
          a = o ? (i ? `${i} - ${o}` : o) : i;
        ((l.title = a || this.#f), this.#x(), this.#$(), this.#b());
      }
      onNavigate(e) {
        const { auto2top: n, topMargin: t } = this.config,
          { path: i, query: o } = this.route,
          a = this.#k();
        if ("history" !== e)
          if (o.id) {
            const e = f(
              `.markdown-section :where(h1, h2, h3, h4, h5, h6)[id="${o.id}"]`,
            );
            e && this.#S(e);
          } else
            "navigate" === e &&
              n &&
              (document.scrollingElement.scrollTop = t ?? 0);
        const r = "navigate" === e,
          c = "id" in o,
          s = !a?.querySelector(".app-sub-sidebar");
        (("/" === i || (r && (c || s))) && V() && this.#w(!1),
          (c || r) && this.#y());
      }
      #y(e = {}) {
        const n = { preventScroll: !0, ...e },
          { query: t } = this.route,
          i = t.id
            ? f(`#${t.id}`)
            : f("#main :where(h1, h2, h3, h4, h5, h6)") || f("#main");
        return (
          i &&
            (i.hasAttribute("tabindex") ||
              (i.setAttribute("tabindex", "-1"),
              i.setAttribute("data-added-tabindex", "true")),
            i.hasAttribute("data-added-tabindex") &&
      ...
      #x() {
        const e = decodeURIComponent(this.router.toURL(this.route.path));
        [".app-nav", ".app-nav-merged"].forEach((n) => {
          const t = f(n);
          if (!t) return;
          const i = g(t, "a")
              .sort((e, n) => n.href.length - e.href.length)
              .find(
                (n) =>
                  e.includes(n.getAttribute("href")) ||
                  e.includes(decodeURI(n.getAttribute("href"))),
              )
              ?.closest("li"),
            o = f(t, "li.active");
          i &&
            i !== o &&
            (o?.classList.remove("active"), i.classList.add("active"));
        });
      }
      #k(e) {
        ...
        if (!n) return;
        e = j(e);
        const t = f(n, "li.active"),
          i = f(
            n,
            `a[href="${e}"], a[href="${decodeURIComponent(e)}"]`,
          )?.closest("li");
        return (
          i &&
            i !== t &&
            (t?.classList.remove("active"), i.classList.add("active")),
          i
        );
      }
      #$(e) {
        ...
        if (!n) return;
        const t = e?.split("?")[0],
          i = f(n, "li[aria-current]"),
          o = f(
            n,
            `a[href="${t}"], a[href="${decodeURIComponent(t)}"]`,
          )?.closest("li");
        return (
          o &&
            o !== i &&
      ...
      #w(e) {
        const n = f(".sidebar");
        if (!n) return;
        const t = g('[aria-controls="__sidebar"]'),
          i = g("body > *:not(main, script), main > .content"),
          o = n.classList.toggle("show", e);
        if (
          (t.forEach((t) => {
            const i = e ?? n.classList.contains("show");
            (t.setAttribute("aria-expanded", String(i)),
              t.setAttribute(
                "aria-label",
                i ? "Hide primary navigation" : "Show primary navigation",
              ));
          }),
          o && V()
            ? i.forEach((e) => e.setAttribute("inert", ""))
            : i.forEach((e) => e.removeAttribute("inert")),
          o)
        )
          n.focus();
        else {
      ...
      #S(e) {
        this.#d();
        const n = f(".markdown-section"),
          t = ["keydown", "mousedown", "touchstart", "wheel"],
          i = {};
        let a = 0,
          r = 0,
          c = !1,
        ...
        const g = [],
          ...
          m = () => {
            u ||
              l ||
              ((l = !0), clearTimeout(i.wait), (a = requestAnimationFrame(h)));
          },
          _ = (n, t) => {
            !c &&
              u &&
              (v.push({ image: n, previousHeight: t }),
              r ||
                (r = requestAnimationFrame(() => {
                  if (((r = 0), c)) return;
                  if (!document.contains(e)) return void d();
                  let n = 0;
                  for (const { image: t, previousHeight: i } of v) {
                    const o =
                  ...
                  if (((v.length = 0), Math.abs(n) < 1))
                    return void (0 === p && d());
                  const t = document.scrollingElement;
                  if (!t) return void d();
                  const i =
                      parseFloat(getComputedStyle(t).scrollPaddingTop) || 0,
                    o = e.getBoundingClientRect().top - i;
                  (Math.abs(o) < 1 || (this.#A(), (t.scrollTop += o)),
                    0 === p && d());
                })));
          };
        ((d = () => {
          c ||
            ...
            clearTimeout(i.wait),
            g.forEach(({ image: e, eventName: n, listener: t }) => {
          ...
          (s = d));
        (t.forEach((e) => {
          window.addEventListener(e, s, { once: !0, passive: !0 });
        }),
          (() => {
            const t = (n ? Array.from(n.querySelectorAll("img")) : []).filter(
              (n) =>
                !n.complete &&
                n.compareDocumentPosition(e) & Node.DOCUMENT_POSITION_FOLLOWING,
            );
            if (!t.length) return void m();
            p = t.length;
            (t.forEach((e) => {
              let n = !1;
              ...
              (e.addEventListener("load", i, { once: !0 }),
                ...
                g.push(
                  { image: e, eventName: "load", listener: i },
                  { image: e, eventName: "error", listener: i },
                ));
            }),
              (i.wait = setTimeout(m, 300)));
          })(),
          (this.#d = s));
      }
      #A() {
        document.addEventListener(
          "scroll",
          () => {
            if (((this.#p = !0), "onscrollend" in window))
              document.addEventListener("scrollend", () => (this.#p = !1), {
                once: !0,
              });
            else {
              let e;
              const n = () => {
                (clearTimeout(e),
                  (e = setTimeout(() => {
                    (document.removeEventListener("scroll", n), (this.#p = !1));
                  }, 100)));
              };
              (document.addEventListener("scroll", n, !1), n());
            }
          },
          { once: !0 },
        );
      ...
      matchVirtualRoute(e) {
        ...
        function o() {
          ...
          if ("function" == typeof s) {
            ...
            if (
              (a((e) =>
                "string" == typeof e ? i(e) : !1 === e ? i(null) : o(),
              ),
              n.length <= 2)
            ) {
              return t(n(e, c));
  ...
  const ft = document.currentScript,
    gt = () => ({
      alias: {},
      auto2top: !1,
      autoHeader: !1,
  ...
  class ht extends (function (e) {
    return class extends e {
      #E(e, n, t, i, o, a) {
        ((e = a ? e : e.replace(/\/$/, "")),
          (e = q(e)) &&
            rt(o.router.getFile(e + t) + n, !1, o.config.requestHeaders).then(
              i,
              (a) => this.#E(e, n, t, i, o),
            ));
      }
      #T;
      #R = () => this.#T && this.#T.abort && this.#T.abort();
      #L = (e, n) => (this.#R(), (this.#T = rt(e, !0, n)), this.#T);
      #j = (e, n) => {
        const { notFoundPage: t, ext: i } = n,
          o = "_404" + (i || ".md");
        let a, r;
        switch (typeof t) {
          case "boolean":
          ...
          case "object":
            ((a = Object.keys(t)
              ...
              .filter((n) => e.match(new RegExp("^" + n)))[0]),
              (r = (a && t[a]) || o));
        }
        return r;
      };
      _loadSideAndNav(e, n, t, i) {
        return () => {
          const o = (e) => {
            (this._renderSidebar(e), i());
          };
          t ? this.#E(e, n, t, o, this, !0) : o(null);
        };
      }
      _fetch(e = o) {
        const { query: n } = this.route,
          { path: t } = this.route;
        if (r(t))
          (history.replaceState(null, "", "#"), this.router.normalize());
        else {
          const i = L(n, ["id"]),
            { loadNavbar: o, requestHeaders: a, loadSidebar: c } = this.config,
            s = this.router.getFile(t);
          ((this.isRemoteUrl = r(s)), (this.isHTML = /\.html$/g.test(s)));
          const u = (n, o, a) => {
              ((this.route.response = a),
                this._renderMain(n, o, this._loadSideAndNav(t, i, c, e)));
            },
            l = (n, o) => {
              ((this.route.response = o),
                this._fetchFallbackPage(t, i, e) || this._fetch404(s, i, e));
            };
          (this.isRemoteUrl
            ? this.#L(s + i, a).then(u, l)
            : this.matchVirtualRoute(t).then((e) => {
                "string" == typeof e ? u(e) : this.#L(s + i, a).then(u, l);
              }),
            o && this.#E(t, i, o, (e) => this._renderNav(e), this, !0));
        }
      }
      _fetchCover() {
        const { coverpage: e, requestHeaders: n } = this.config,
          t = this.route.query,
          i = q(this.route.path);
        if (e) {
          let o = null;
          const a = this.route.path;
          if ("string" == typeof e) "/" === a && (o = e);
          else if (Array.isArray(e)) o = e.indexOf(a) > -1 && "_coverpage";
          else {
            const n = e[a];
            o = !0 === n ? "_coverpage" : n;
          }
          const r = Boolean(o) && this.config.onlyCover;
          return (
            o
              ? ((o = this.router.getFile(i + o)),
                (this.coverIsHTML = /\.html$/g.test(o)),
                rt(o + L(t, ["id"]), !1, n).then((e) =>
                  this._renderCover(e, r),
                ))
              : this._renderCover(null, r),
            r
          );
        }
      }
      $fetch(e = o, n = this.onNavigate.bind(this)) {
        const t = () => {
      ...
      _fetchFallbackPage(e, n, t = o) {
        const {
          requestHeaders: i,
          fallbackLanguages: a,
          fallbackDefaultLanguage: r,
          loadSidebar: c,
        } = this.config;
        if (!a) return !1;
        const s = e.split("/")[1];
        if (-1 === a.indexOf(s)) return !1;
        const u = this.router.getFile(e.replace(new RegExp(`^/${s}`), r));
        return (
          this.#L(u + n, i).then(
            (i, o) => this._renderMain(i, o, this._loadSideAndNav(e, n, c, t)),
            (i) => this._fetch404(e, n, t),
          ),
          !0
        );
      }
      _fetch404(e, n, t = o) {
        const {
          ...
          c = this._loadSideAndNav(e, n, i, t);
        if (r) {
          const n = this.#j(e, this.config);
          return (
            this.#L(this.router.getFile(n), a).then(
              (e, n) => this._renderMain(e, n, c),
              (e) => this._renderMain(null, {}, c),
            ),
            !0
          );
        }
            ...
            return class extends e {
              ...
              updateRender() {
                (this.router?.normalize(),
                  ...
                  p.setAttribute("data-page", this.route.file ?? ""));
              }
              initRouter() {
                const e = this.config;
                let n;
                ((n =
                  "history" === (e.routerMode || "hash") ? new H(e) : new D(e)),
                  (this.router = n),
                  this.updateRender(),
                  (U = this.route),
                  n.onchange((e) => {
                    (this.updateRender(),
                      ...
                      U.path !== this.route.path
                        ? (this.$fetch(o, this.onNavigate.bind(this, e.source)),
                          (U = this.route))
                        : this.onNavigate(e.source));
                  }));
              }
            };
          })(
              ...
              return class extends e {
                ...
                callHook(e, n, t = o) {
                  const i = this._hooks[e],
                    a = this.config.catchPluginErrors,
                    r = function (e) {
                      const o = i[e];
                      if (e >= i.length) t(n);
                      else if ("function" == typeof o) {
                        const t = "Docsify plugin error";
                        if (2 === o.length)
                          try {
                            o(n, (t) => {
                              ((n = void 0 === t ? n : t), r(e + 1));
                            });
                          } catch (n) {
                            if (!a) throw n;
                            (console.error(t, n), r(e + 1));
                          }
                        else
                          try {
                            const t = o(n);
      ...
      (super(),
        (this.config = (function (e, n = {}) {
          !1 !==
            ...
            (n.keyBindings = Object.assign(
              {
                toggleSidebar: {
                  bindings: ["\\"],
                  callback(e) {
                    const n = document.querySelector(".sidebar-toggle-button");
                    n && n.click();
                  },
                },
              },
          ...
          const o =
            ft ||
            Array.from(document.getElementsByTagName("script")).filter((e) =>
              /docsify\./.test(e.src),
            )[0];
          if (o)
            for (const e of Object.keys(n)) {
              const a = o.getAttribute("data-" + t(e));
              i(a) &&
                (console.warn(
                  `DEPRECATION: data-* attributes on the docsify global script (f.e. ${"data-" + t(e)}) are deprecated.`,
                ),
                (n[e] = "" === a || a));
            }
          return (
