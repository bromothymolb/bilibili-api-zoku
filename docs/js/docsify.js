!(function () {
  ...
  function R(e) {
    ...
    if (r)
      for (var i in n) {
        !l.call(n, i) ||
          (c((t = r.getAttribute("data-" + a(i)))) && (n[i] = "" === t || t));
      }
    return (
  ...
  var q,
    ...
    U = (function t(e) {
      ...
      var l = s.document,
        ...
        y = qe(i, "parentNode");
      "function" != typeof n ||
        ((n = a.createElement("template")).content &&
          n.content.ownerDocument &&
          (a = n.content.ownerDocument));
      var k = ct(e, l),
        w = k && ee ? k.createHTML("") : "",
        x = a.implementation,
      ...
      function $(e) {
        (ce && ce === e) ||
          ...
          (se =
            "ADD_URI_SAFE_ATTR" in e ? Ie(je(le), e.ADD_URI_SAFE_ATTR) : le),
          (ae =
            "ADD_DATA_URI_TAGS" in e ? Ie(je(oe), e.ADD_DATA_URI_TAGS) : oe),
      ...
      function ve(e) {
        ...
        return (
          (t && t.documentElement) ||
            ((r = (t = x.createHTMLDocument("")).body).parentNode.removeChild(
              r.parentNode.firstElementChild,
            ),
            (r.outerHTML = i)),
          e &&
            n &&
        ...
        if (D[n] && !H[n])
          return (e instanceof o &&
            !(function (e) {
              var t = y(e);
              (t && t.tagName) ||
                (t = { namespaceURI: Ee, tagName: "template" });
              var n = Le(e.tagName),
                r = Le(t.tagName);
              return e.namespaceURI === Te
                ...
                : e.namespaceURI === Ae
                  ...
                  : e.namespaceURI === Ee &&
                    ...
                    ((r = Ie({}, ["title", "style", "font", "a", "script"])),
                    !fe[n] && (r[n] || !he[n]));
            })(e)) ||
            (("noscript" === n || "noembed" === n) &&
              Pe(/<\/no(script|embed)/i, e.innerHTML))
            ? (ge(e), 1)
            : (W &&
                3 === e.nodeType &&
                ((t = e.textContent),
                ...
                (t = ze(t, L, " ")),
                e.textContent !== t &&
                  (Oe(c.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
      ...
      function Se(e) {
        ...
        for (ke("beforeSanitizeShadowDOM", e, null); (t = n.nextNode()); )
          (ke("uponSanitizeShadowNode", t, null),
            we(t) || (t.content instanceof u && Se(t.content), _e(t)));
      ...
      return (
        (c.sanitize = function (e, t) {
          ...
          if (
            ...
            if (e instanceof p)
              (1 ===
                (t = (r = ve("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
                  .nodeType &&
                "BODY" === t.nodeName) ||
              "HTML" === t.nodeName
                ? (r = t)
          ...
          for (var o = be(re ? e : r); (n = o.nextNode()); )
            (3 === n.nodeType && n === i) ||
              we(n) ||
              (n.content instanceof u && Se(n.content), _e(n), (i = n));
  ...
  function B(e) {
    ...
    (q || ((e = x("div")).classList.add("progress"), o(v, e), (q = e)),
      (t = i
        ? 80 < (t = parseInt(q.style.width || 0, 10) + i)
          ? 80
          : t
        : Math.floor((n / r) * 100)),
      (q.style.opacity = 1),
  ...
  function te(e, t) {
    ...
    for (n in e)
      -1 < t.indexOf(n) ||
        r.push(e[n] ? (J(n) + "=" + J(e[n])).toLowerCase() : J(n));
              ...
              if (((o = t = u[f]), f !== d - 1)) {
                if (
                  ...
                  this.options.pedantic
                    ? r[1].length > h[1].length
                    : r[1].length > h[0].length || 3 < r[1].length)
                ) {
                  (u.splice(f, 2, u[f] + "\n" + u[f + 1]), f--, d--);
                  continue;
                }
        ...
        (e.prototype.autolink = function (e, t) {
          ...
          if (e) {
            var n,
              t =
                "@" === e[2]
                  ? "mailto:" + (n = It(this.options.mangle ? t(e[1]) : e[1]))
                  : (n = It(e[1]));
            return {
              type: "link",
              raw: e[0],
  ...
  ((Ct.def = Mt(Ct.def)
    ...
    (Ct.paragraph = Mt(Ct._paragraph)
      ...
      .replace("tag", Ct._tag)
      .getRegex()),
    (Ct.blockquote = Mt(Ct.blockquote)
      .replace("paragraph", Ct.paragraph)
      .getRegex()),
    (Ct.normal = Lt({}, Ct)),
    (Ct.gfm = Lt({}, Ct.normal, {
      nptable:
  ...
  ((zt.punctuation = Mt(zt.punctuation)
    ...
    (zt.reflinkSearch = Mt(zt.reflinkSearch, "g")
  ...
  var Yt = (function () {
      ...
      return (
            ...
            switch ((a = e[s]).type) {
              ...
              case "table":
                ...
                for (r = a.cells.length, t = 0; t < r; t++)
                  for (
                    i = a.cells[t], a.tokens.cells[t] = [], n = 0;
                    n < i.length;
                    n++
                  )
                    ((a.tokens.cells[t][n] = []),
              ...
              case "blockquote":
                ...
                break;
              case "list":
                for (r = a.items.length, t = 0; t < r; t++)
        ...
        (n.prototype.inlineTokens = function (e, t, n, r) {
          ...
          for (; e; )
            if ((o || (s = ""), (o = !1), (i = this.tokenizer.escape(e))))
            ...
            switch ((c = e[y]).type) {
              ...
              case "table":
                ...
                for (
                  ...
                  for (
                    s = "", a = (o = c.tokens.cells[n]).length, r = 0;
                    r < a;
                    r++
                  )
  ...
  function un(e, n, r) {
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + ln(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
  ((un.options = un.setOptions =
    ...
    (un.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && un.walkTokens(n, t.walkTokens),
          an.parseInline(n, t)
        );
      } catch (e) {
        if (
            ...
            C = {
              ...
              highlightElement: function (e, t, n) {
                ...
                a &&
                  ...
                  (a.className =
                    a.className.replace(c, "").replace(/\s+/g, " ") +
                    " language-" +
                    r);
                var o = {
                  element: e,
                ...
                (C.hooks.run("before-highlight", o),
                  o.grammar
                    ? t && l.Worker
                      ? (((t = new Worker(C.filename)).onmessage = function (
                          e,
                        ) {
                          s(e.data);
                        }),
        ...
        "undefined" != typeof self &&
          ...
          o.hooks.add("before-sanity-check", function (e) {
            ...
            a.matches(u) &&
              ((e.code = ""),
              a.setAttribute(l, c),
              ((t = a.appendChild(document.createElement("CODE"))).textContent =
                "Loading…"),
  ...
  var An = {},
    ...
    En = function (i, e) {
      ...
      var e = i.markdown || {},
        o = p(e)
          ? e(pn, t)
          : (pn.setOptions(b(e, { renderer: b(t, e.renderer) })), pn);
      ((this._marked = o),
        (this.compile = function (n) {
          ...
          return (
            r ? (a.toc = a.cacheTOC[t]) : (a.cacheTOC[t] = [].concat(a.toc)),
            e
          );
        }));
    };
  ((En.prototype.compileEmbed = function (e, t) {
    ...
    if (((t = a), i.include))
      return (
        ne(e) ||
          (e = le(this.contentBase, ie(this.router.getCurrentPath()), e)),
        i.type && (r = Tn[i.type])
                ...
                (a.push(r.substring(o, n - 1)),
                  ...
                  a.push(
                    (i && i[t]) ||
                      function (e) {
                        return (
                          "00" + ("string" == typeof C[t] ? e[C[t]]() : C[t](e))
                        ).slice(-t.length);
                      },
                  ));
              }),
  ...
  function Fn(e) {
    ...
    if (((e = e || "<h1>404 - Not found</h1>"), "Vue" in window))
      for (
        var a = 0, o = w(".markdown-section > *").filter(t);
        a < o.length;
        a += 1
      ) {
        var s = o[a];
  ...
  function zn(e) {
    ...
    (c
      ...
      t.themeColor &&
        (m.head.appendChild(
          x("div", "<style>:root{--theme-color: " + t.themeColor + ";}</style>")
            .firstElementChild,
        ),
        (o = t.themeColor),
        (window.CSS &&
      ...
      return (
        ...
        (e.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e, !0), query: ee(t) }
          );
        }),
      ...
      return (
        ...
        (e.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e), query: ee(t) }
          );
        }),
        e
      );
  ...
  function Hn(t, n, r, i, a, e) {
    ((t = e ? t : t.replace(/\/$/, "")),
      (t = ie(t)) &&
        G(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(
          i,
          function (e) {
            return Hn(t, n, r, i, a);
          },
  ...
  ((Vn._init = function () {
    ...
    ((o.config = R(o)),
      ...
      V(o, "init"),
      (e = new (
        "history" === ((e = (r = o).config).routerMode || "hash") && f ? Dn : Pn
      )(e)),
      (r.router = e),
      jn(r),
      (In = r.route),
      e.onchange(function (e) {
        (jn(r),
          r._updateRender(),
          In.path !== r.route.path
            ? (r.$fetch(u, r.$resetEvents.bind(r, e.source)), (In = r.route))
            : r.$resetEvents(e.source));
      }),
      zn(o),
      qn(o),
    ...
    (Zn._renderSidebar = function (e) {
      ...
      (i && n
        ? (n.parentNode.innerHTML += this.compiler.subSidebar(r) || "")
      ...
      (!(function (e) {
        ...
        for (var r, i = 0, a = n.length; i < a; i += 1) {
          var o,
            ...
            c = l.querySelector("a");
          c &&
            ("/" !== (o = c.getAttribute("href")) &&
              ((c = (s = e.parse(o)).query.id),
              (s = s.path),
              c && (o = _e(s, c))),
